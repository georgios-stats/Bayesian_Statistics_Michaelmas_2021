...
hierarhicalmodel="
  model {
    ...
    # within model prior + augmantation
...
pr_1 = mean(as.numeric(ind.smpl[2,,]==0) * as.numeric(ind.smpl[3,,]==0)* as.numeric(ind.smpl[4,,]==0))
pr_2 = mean(as.numeric(ind.smpl[2,,]==1) * as.numeric(ind.smpl[3,,]==0)* as.numeric(ind.smpl[4,,]==0))
pr_3 = mean(as.numeric(ind.smpl[2,,]==0) * as.numeric(ind.smpl[3,,]==1)* as.numeric(ind.smpl[4,,]==0))
pr_4 = mean(as.numeric(ind.smpl[2,,]==1) * as.numeric(ind.smpl[3,,]==1)* as.numeric(ind.smpl[4,,]==0))
pr_5 = mean(as.numeric(ind.smpl[2,,]==1) * as.numeric(ind.smpl[3,,]==1)* as.numeric(ind.smpl[4,,]==1))
pr_6 = mean(as.numeric(ind.smpl[2,,]==0) * as.numeric(ind.smpl[3,,]==0)* as.numeric(ind.smpl[4,,]==1))
pr_7 = mean(as.numeric(ind.smpl[2,,]==1) * as.numeric(ind.smpl[3,,]==0)* as.numeric(ind.smpl[4,,]==1))
pr_8 = mean(as.numeric(ind.smpl[2,,]==0) * as.numeric(ind.smpl[3,,]==1)* as.numeric(ind.smpl[4,,]==1))
